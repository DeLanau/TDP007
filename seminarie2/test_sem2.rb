...
class MyTest < Test::Unit::TestCase
   ...
   def test_2
      list = create_day_list
      display(list)
      assert_equal(8, list.length)
      assert_equal("The Dark Carnival - 101.9FM", list[0].summary)
      assert_equal("Sinister Sundays", list[-1].summary)
      assert_equal("2008-01-04 10:00pm EST", list[0].date)
      assert_equal("The Dark Carnival - 101.9FM", list[2].summary)
      assert_equal("2008-01-11 10:00pm EST", list[2].date)
